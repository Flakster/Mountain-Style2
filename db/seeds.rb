...
Article.create({ title: 'Silence is a treasure',
                 body: 'Nam libero tempore, cum soluta nobis
                 ...
                 asperiores repellat',
                 image: 'defimg.jpg', author_id: 1 })
Article.create({ title: 'May your food be your medicine',
...
Article.create({ title: 'The peaceful life near the clouds',
                 body: 'Sed ut perspiciatis unde omnis iste
                        ...
                        quaerat voluptatem',
                 image: 'landscape.jpg', author_id: 1 })
Article.create({ title: 'Breathe clean air is priceless',
                 body: 'Ut enim ad minima veniam, quis nostrum
                 ...
                 image: 'logcabin.jpg', author_id: 1 })
Article.create({ title: 'Break the chains',
                 body: 'Et harum quidem rerum facilis est
                        ...
                        non recusandae. Itaque earum rerum
...
Article.create({ title: 'The peaceful life near the clouds',
                 ...
                 image: 'landscape.jpg',
                 author_id: 1 })
Article.create({ title: 'Mother nature\'s embrace',
                 body: 'Et harum quidem rerum facilis est
                        et expedita distinctio. Nam libero
                        tempore, cum soluta nobis est eligendi
                        ...
                        rerum hic tenetur a sapiente delectus, ut
